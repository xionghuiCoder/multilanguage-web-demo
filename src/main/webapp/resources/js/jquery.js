		...
		(
				...
				function(window, noGlobal) {
					...
					(function() {
						...
						// Support: Firefox, Android 2.3 (Prefixed box-sizing
						// versions).
						...
						function computePixelPositionAndBoxSizingReliable() {
							// Support: Firefox, Android 2.3 (Prefixed
							// box-sizing versions).
						...
						// Use window.getComputedStyle because jsdom on node.js
					...
					function defaultPrefilter(elem, props, opts) {
						...
						if (elem.nodeType === 1
							...
							// Get default display if display is currently
							// "none"
							if (display === "none") {
								...
								if (support.cors || xhrSupported
									...
									return {
										send : function(headers, complete) {
											...
											// Do send the request
											// This may raise an exception which
											// is actually
